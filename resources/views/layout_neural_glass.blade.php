...
<head>
    ...
    <link href="/neural_glass/templatemo-neural-style.css" rel="stylesheet">
...
<header class="glass">
    <nav>
        ...
        <ul class="nav-links">
            <li><a href="/students">Tous</a></li>
            <li><a href="/students/create">Créer</a></li>
        </ul>
    ...
    <div class="mobile-nav">
        <a href="/students">Tous</a>
        <a href="/students/create">Créer</a>
    </div>
</header>
...
{{--            <a href="#features" class="cta-button">Initialize Neural Link</a>--}}
{{--            <a href="#showcase" class="cta-button secondary">Explore Matrix</a>--}}
{{--        </div>--}}
    </div>
</section>
...
{{--<script src="/neural_glass/templatemo-neural-scripts.js"></script>--}}
</body>
</html>
